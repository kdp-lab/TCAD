...
* Outline the work done using Synopsys TCAD suite and associated tools in the context of SmartPixels

* Provide an introduction to the software, including the functionality of various tools
* Introduces how to define input files and perform simulations specify pixel sensor geometry, doping, and applied voltage, with an eye to future modifications of the simulation parameters/optimization
* Provide .c scripts to analyze output
