;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Script for creating 200um thick sensor with 55um pixel size in 2D
;;
...
;; X-position on incoming MIP relative midpoint of sensor
(define midPoint (/ (* 3 pitch) 2.0))
(define MIP_pos (+ midPoint @Xmip@))
...
(sdegeo:create-rectangle (position 0 0 0.0)  (position (* 3 pitch) depth 0.0) "Silicon" "bulk")
...
(sdedr:define-refeval-window "BOT_IMP_line" "Line" (position 0 depth 0) (position (* 3 pitch) depth 0))
(sdegeo:set-current-contact-set "BOT_electrode")
(sdegeo:set-contact-edges (list (car (find-edge-id (position 1 depth 0)))) "BOT_electrode")
...
(sdegeo:set-active-work-plane "base")
(sdedr:define-refeval-window "REF_ALL" "Rectangle" (position -10 (+ depth 10) 0) (position (+ (* 3 pitch) 10) -10 0))
...
(sdedr:define-refeval-window "REF_BOT_IMP" "Rectangle" (position 0 depth 0) (position (* 3 pitch) (- depth 1.5) 0))
(sdedr:define-refeval-window "REF1_BOT" "Rectangle" (position 0 depth 0) (position (* 3 pitch) (- depth 2.5) 0))
(sdedr:define-refeval-window "REF2_BOT" "Rectangle" (position 0 (+ depth 1.1) 0) (position (* 3 pitch) (- depth 5) 0))
(sdedr:define-refeval-window "REF3_BOT" "Rectangle" (position 0 (+ depth 1.1) 0) (position (* 3 pitch) (- depth 10) 0))
...
(sde:build-mesh "snmesh" "" "n@node@_msh.tdr")
(exit)
